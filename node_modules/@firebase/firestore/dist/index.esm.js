...
var IndexedDbLruDelegate = /** @class */ (function () {
    ...
    IndexedDbLruDelegate.prototype.isPinned = function (txn, docKey) {
        return this.inMemoryPins.containsKey(txn, docKey).next(function (isPinned) {
            if (isPinned) {
...
var MemoryEagerDelegate = /** @class */ (function () {
    ...
    MemoryEagerDelegate.prototype.isReferenced = function (txn, key) {
        ...
        return PersistencePromise.or([
            ...
            function () { return _this.inMemoryPins.containsKey(txn, key); }
        ]);
    };
...
var MemoryLruDelegate = /** @class */ (function () {
    ...
    MemoryLruDelegate.prototype.forEachOrphanedDocumentSequenceNumber = function (txn, f) {
        this.orphanedSequenceNumbers.forEach(function (_, sequenceNumber) {
            return f(sequenceNumber);
        });
        return PersistencePromise.resolve();
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, PersistencePromise.forEach(limboKeys, function (limboKey) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!this.queryViewsByTarget[targetId]) return [3 /*break*/, 6];
                        _a = state;
                        switch (_a) {
